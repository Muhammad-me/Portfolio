...
export default function Footer() {
  return (
    <div className="container mx-auto px-5 py-5 lg:py-40">
      <div className="flex justify-between">
        ...
        <div>
          ...
          <div className="flex space-x-4 items-center justify-center lg:justify-start mt-10">
            ...
            <Link
              href={
                "https://www.linkedin.com/in/muhammad-majidhanov-864b61248/"
              }
            >
              <LinkedIn />
            </Link>
